...
/***/ function(module, exports, __webpack_require__) {
	...
	var posts = [{ title: 'hello' }, { title: 'I am victor !' }, { title: 'I am working in diet code!' }];

	var posts$ = _Rx2.default.Observable.from(posts);

	posts$.subscribe(function (posts) {
	    console.log(posts);
	}, function (err) {
	    console.log(err);
	}, function (complete) {
	...
	var set = new Set(['santosh', 44, { job: 'fullstack developer' }]);
	...
	var victorPromise = new Promise(function (resolve, reject) {
	...
	var victorSource$ = _Rx2.default.Observable.fromPromise(victorPromise);
	...
	var victorInputSource$ = _Rx2.default.Observable.fromEvent((0, _jquery2.default)('#input'), 'keyup');

	victorInputSource$.subscribe(function (e) {
	    _Rx2.default.Observable.fromPromise(getUser(e.target.value)).subscribe(function (x) {
	        debugger;
	        (0, _jquery2.default)('#name').text(x.data.name);
	        (0, _jquery2.default)('#company').text(x.data.company);
	        (0, _jquery2.default)('#location').text(x.data.location);
